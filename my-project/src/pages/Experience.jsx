...
function createExperience(props) {
    return (
        <div key={props.id} className="bg-white/10 backdrop-blur-sm rounded-lg border border-white/20 shadow-lg w-full h-auto p-5 flex flex-col">
...
export default function Experience() {
    return (
        <div id="experience" className="h-auto w-full text-white z-10">
            <div className="grid gap-3 grid-cols-1 md:grid-cols-[1fr_2fr] px-5 xl:pt-20 sm:pt-10 pt-5 lg:pl-50 lg:pr-25 sm:pl-25 sm:pr-6">
